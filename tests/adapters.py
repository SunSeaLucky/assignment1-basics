...
def run_linear(
    ...
    """
    layer = cs336_basics.model.Linear(d_in, d_out, weights.device, weights.dtype)
...
def run_embedding(
    ...
    """
    embedding = cs336_basics.model.Embedding(vocab_size, d_model, weights.device, weights.dtype)
...
def run_swiglu(
    ...
    swiglu = cs336_basics.model.SwiGLU(d_model, d_ff, w1_weight.device, w1_weight.dtype)
...
def run_rope(
    ...
    """
    rope = cs336_basics.model.RotaryPositionalEmbedding(theta, d_k, max_seq_len, in_query_or_key.device)
